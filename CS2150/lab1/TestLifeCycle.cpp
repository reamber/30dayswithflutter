//Amber Liu, al7bf, TestLifeCycle.cpp, 09/04/2018
//c++ file that contains main() and prototypes
#include <iostream>
#include <string>
#include "LifeCycle.h"
using namespace std;
...
//---------------------------------------------------------- prototypes
MyObject getMaxMyObj(const MyObject o1, const MyObject o2); //prototypes
int cmpMyObj(const MyObject o1, const MyObject o2); //prototypes
void swapMyObj(MyObject& o1, MyObject& o2); //prototypes

...
/** @class middleearth middleearth.h "inc/middleearth.h"
 * @brief This is middleearth class 
 */
...
* @param seed to construct Middle Earth 
*/
...
/**@brief prints out the created world
*/
...
/**@brief returns the distances between cities
*@return distances between two cities as float

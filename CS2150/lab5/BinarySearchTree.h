...
class BinarySearchTree {
 ...
 private:
  ...
  BinaryNode* insert(BinaryNode*& n, const string& x);//insert helper
  string pathToHelp(BinaryNode* n, const string& x) const;
  bool findHelp(BinaryNode* n, const string& x) const;
  //int countNodes(BinaryNode* node) const;
  //void cleanTree(BinaryNode* node);
};
